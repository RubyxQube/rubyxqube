...
const FAQ = [
  ...
  { q: "Can the digital receptionist handle seasonal service questions?", a: "Absolutely. We train it with your seasonal services: spring cleanup, irrigation startup, summer maintenance, fall leaf removal, winter snow removal, and update it as your offerings change." },
  ...
  return (
    <div className="pageMinHeight">
      <Helmet>
        ...
        <meta name="description" content="Custom websites for landscaping companies in Boise and the Treasure Valley. Portfolio galleries, smart lead capture, seasonal SEO. Starting at $499/mo, no setup fee." />
        <meta property="og:title" content="Landscaping Web Design Boise Idaho | RubyxQube" />
        <meta property="og:description" content="Custom websites with portfolio galleries and smart lead capture for Treasure Valley landscaping companies." />
      ...
      <section className="surface heroSurface">
        <div className="heroSection">
          ...
          <p className="p" style={{ fontSize: 17, maxWidth: 560, marginBottom: 32 }}>
            A great landscaping company earns trust with photos. We build custom portfolio-forward sites with built-in smart lead capture, so your best work is selling for you around the clock.
          </p>
        ...
        <div className="section">
          ...
          <div className="grid cols-2" style={{ gap: 24 }}>
            {[
              ...
              { num: "02", icon: <MessageCircle size={22} color="var(--accent)" strokeWidth={1.75} />, title: "digital receptionist trained on your services", body: "Handles 'do you do spring cleanup?' at 9pm on a Sunday. Captures leads with name, contact info, and what they need, and texts you immediately." },
        ...
        <div className="section" style={{ paddingTop: 40, paddingBottom: 40 }}>
          <div className="card cardHighlight" style={{ display: "flex", flexWrap: "wrap", gap: 28, alignItems: "center", justifyContent: "space-between" }}>
            <div style={{ flex: "1 1 280px" }}>
              ...
              <h3 className="h3" style={{ marginBottom: 10 }}>Custom landscaping site + digital receptionist + monthly reports. No setup fee.</h3>
              <p className="p" style={{ marginBottom: 0 }}>Built for your business, launched fast, and managed month-to-month after a 6-month minimum.</p>
            </div>
