  ...
  return (
    <div className="pageMinHeight">
      <Helmet>
        ...
        <meta property="og:description" content="Custom websites with smart lead capture for Eagle, ID businesses. Premium design, no setup fee, month-to-month after 6 months." />
        ...
        <script type="application/ld+json">{JSON.stringify({ "@context": "https://schema.org", "@type": "LocalBusiness", "name": siteConfig.brand, "url": `${siteConfig.siteUrl}/web-design-eagle`, "telephone": siteConfig.phoneDisplay, "email": siteConfig.email, "address": { "@type": "PostalAddress", "addressLocality": "Boise", "addressRegion": "ID", "addressCountry": "US" }, "areaServed": "Eagle, Idaho", "serviceType": "Web Design" })}</script>
      </Helmet>
        ...
        <div className="section" style={{ paddingTop: 40, paddingBottom: 40 }}>
          <div className="card cardHighlight" style={{ display: "flex", flexWrap: "wrap", gap: 28, alignItems: "center", justifyContent: "space-between" }}>
            <div style={{ flex: "1 1 280px" }}>
              ...
              <p className="p" style={{ marginBottom: 0 }}>Start without a large upfront commitment. After the 6-month minimum, cancel with 30 days notice.</p>
            </div>
