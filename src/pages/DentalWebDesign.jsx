...
const FAQ = [
  { q: "Can the digital receptionist answer insurance questions?", a: "Yes: we train it with your accepted insurance plans, how to verify coverage, and what the typical patient experience looks like. It can answer 'Do you take Delta Dental?' or 'Are you in-network with Blue Cross?' based on what you tell us during onboarding." },
  ...
  { q: "How do you handle HIPAA considerations?", a: "The digital receptionist handles general questions and appointment scheduling direction, not protected health information. We do not collect medical history, treatment details, or insurance ID numbers through the chat. The system is designed to stay on the right side of that line." },
      ...
      <section className="surface heroSurface">
        <div className="heroSection">
          ...
          <p className="p" style={{ fontSize: 17, maxWidth: 560, marginBottom: 32 }}>
            New dental patients do their research before calling. We build custom dental websites designed to answer their questions, build trust, and get them booked, with a digital receptionist that handles the first conversation at any hour.
          </p>
          ...
          <div className="grid cols-2" style={{ gap: 48, alignItems: "center" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              {[
                ...
                "New patient intake questions are a high-volume, repetitive front-desk task it can handle",
              ].map((item) => (
      ...
      <section className="surface" style={{ background: "transparent" }}>
        <div className="section">
          ...
          <div className="grid cols-2" style={{ gap: 24 }}>
            {[
              { num: "01", icon: <MessageCircle size={22} color="var(--accent)" strokeWidth={1.75} />, title: "digital receptionist for new patient questions", body: "Handles insurance questions, new patient intake, what to expect at a first visit, and how to schedule, at any hour. Captures lead info and texts you immediately when someone's ready to book." },
              { num: "02", icon: <Calendar size={22} color="var(--accent)" strokeWidth={1.75} />, title: "Appointment booking integration", body: "Direct patients to your booking system from the site and the receptionist. We integrate with Cal.com or your existing scheduling tool. Custom booking systems are available under Momentum." },
