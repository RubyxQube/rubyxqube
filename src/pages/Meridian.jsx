  ...
  return (
    <div className="pageMinHeight">
      <Helmet>
        ...
        <meta property="og:description" content="Custom websites with smart lead capture for Meridian, ID service businesses. No setup fee, month-to-month after 6 months." />
