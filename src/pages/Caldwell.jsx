  ...
  return (
    <div className="pageMinHeight">
      <Helmet>
        ...
        <meta name="description" content="Custom websites and digital receptionists for Caldwell, Idaho small businesses. Canyon County web design with 24/7 smart lead capture. Starting at $499/mo, no setup fee." />
        <meta property="og:title" content="Web Design for Caldwell, Idaho Businesses | RubyxQube" />
        <meta property="og:description" content="Custom websites with smart lead capture for Caldwell, ID businesses. No setup fee, month-to-month after 6 months." />
      ...
      <section className="surface heroSurface">
        <div className="heroSection">
          ...
          <p className="p" style={{ fontSize: 17, maxWidth: 540, marginBottom: 32 }}>
            Caldwell is a growing market with less digital competition than Boise or Meridian, which means a well-built site with proper local SEO can make a real impact faster. We build custom websites with smart lead capture for Canyon County businesses that want to stand out.
          </p>
        ...
        <div className="section">
          ...
          <div className="grid cols-3">
            {[
              ...
              { num: "02", title: "digital receptionist", body: "Handles questions and captures leads at any hour. Trained on your services, pricing, and service area: no missed opportunities, even on weekends." },
        ...
        <div className="section" style={{ paddingTop: 40, paddingBottom: 40 }}>
          <div className="card cardHighlight" style={{ display: "flex", flexWrap: "wrap", gap: 28, alignItems: "center", justifyContent: "space-between" }}>
            <div style={{ flex: "1 1 280px" }}>
              ...
              <h3 className="h3" style={{ marginBottom: 10 }}>Custom site + digital receptionist + monthly reports. No setup fee.</h3>
              <p className="p" style={{ marginBottom: 0 }}>Same pricing whether you're in Caldwell or Boise. A 6-month minimum, then month-to-month with 30 days notice.</p>
            </div>
