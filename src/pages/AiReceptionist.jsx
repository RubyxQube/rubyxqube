            ...
            {[
              {
                ...
                price: "$399/mo",
                detail: "No setup fee",
                bullets: ["AI receptionist included", "5–10 page custom site", "GA4 + Search Console", "Monthly report", "60 min/mo updates"],
                highlight: true,
                cta: "/contact",
              },
              {
                ...
                price: "$999/mo",
                detail: "No setup fee",
                bullets: ["Everything in Autopilot", "Developer on call", "Unlimited edits", "Monthly AI tuning", "GBP management"],
                highlight: false,
                cta: "/contact",
              },
              {
