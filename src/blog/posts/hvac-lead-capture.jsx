...
export default function HvacLeadCapture() {
  return (
    <>
      <p>HVAC has one of the most predictable demand patterns of any service business — and it's almost entirely misaligned with business hours. When temperatures in Boise hit 105 in July or drop below 15 in January, people don't wait until 9am to search for help. They search right now, at whatever hour that is.</p>
      ...
      <p>The average HVAC service call in the Boise area runs $150–$400 for a diagnostic and repair. An AC unit replacement is $3,000–$8,000. A furnace replacement is $2,500–$6,000.</p>
      <p>If you're missing two service calls per week because no one responded after hours, that's $1,200–$3,200 per month in lost revenue — at the low end. If even one of those leads becomes a replacement, the number is much higher.</p>
